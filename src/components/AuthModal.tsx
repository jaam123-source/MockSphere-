        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative space-y-6 text-left">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-2">
              Authenticate securely with your personal Google account to synchronize your assessment and interview records.
            </p>
          </div>
          ...
          <div className="space-y-4 pt-1">
            <button
              ...
              className="w-full py-4 px-4 bg-white hover:bg-slate-100 active:bg-slate-200 text-slate-800 font-bold text-sm rounded-2xl shadow-xl transition-all flex items-center justify-center gap-3 cursor-pointer border border-slate-200 focus:outline-none focus:ring-4 focus:ring-indigo-500/30"
            >
