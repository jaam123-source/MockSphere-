...
import { TECHNICAL_DOMAINS_LIST } from './server/technicalQuestionBank';
import {
...
// Helper to get authenticated user ID from Authorization header or session cookie
...
async function start() {
  ...
  app.listen(PORT, '0.0.0.0', () => {
    console.log(`AI-Powered Interview System listening on http://0.0.0.0:${PORT}`);
  });
}
